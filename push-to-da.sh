...
declare -a MEDIA_FILES=(
  ...
  "media/immersive_cinematic1.webp"
  "media/immersive_cinematic2.png"
  "media/immersive_cinematic3.png"
  "media/immersive_cinematic4.png"
  "media/immersive_cinematic5.png"
  "media/immersive_cinematic6.png"
  "media/immersive_cinematic7.png"
  "media/immersive_cinematic8.png"
  "media/immersive_details1.png"
  "media/immersive_details2.png"
  "media/immersive_details3.png"
  "media/immersive_details4.png"
  "media/immersive_details5.png"
  "media/immersive_hero1.png"
  "media/immersive_hero2.png"
  "media/immersive_hero3.png"
  "media/immersive_hero4.png"
)
